...
const Astronaut = () => {
  ...
  const planet = useRef()
  const starsBig = useRef()
  const starsSmall = useRef()
  const circlesSmall = useRef()
  const circlesBig = useRef()
...
version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <g>
            ...
            <g id="planet" ref={planet}>
              ...
              <circle ref={craterBig}
              id="craterBig" fill="none" stroke="#0E0620" strokeWidth="3" strokeMiterlimit="10" cx="548.891"
                cy="62.319" r="13.074" />

              <circle ref={craterSmall}
              id="craterSmall" fill="none" stroke="#0E0620" strokeWidth="3" strokeMiterlimit="10" cx="591.743"
                cy="158.918" r="7.989" />
            ...
            <g id="stars">
              ...
              <g id="circlesBig">
                ...
                <circle  ref={circlesBig}
                fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round" strokeMiterlimit="10"
              ...
              <g id="circlesSmall">
                <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651"  ref={circlesSmall}/>
                <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651"  ref={circlesSmall} />
                <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651"  ref={circlesSmall} />
                <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651"   ref={circlesSmall}/>
                <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651"   ref={circlesSmall}/>
                <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651"  ref={circlesSmall} />
                <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651"  ref={circlesSmall} />
              </g>
            </g>
            <g id="spaceman" clipPath="url(cordClip)" ref={spaceMan}>
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
              ...
              <g id="head">
                ...
                <path ref={headStripe}
                id="headStripe" fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round"
                  strokeLinejoin="round" strokeMiterlimit="10" d="
                ...
                <g clipPath="url(#GlassClip)">
                  <polygon ref={glassShine}
                   id="glassShine" fill="none" stroke="#0E0620" strokeWidth="3" strokeMiterlimit="10" points="
